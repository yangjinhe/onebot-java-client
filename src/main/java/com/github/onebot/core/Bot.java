...
import com.github.onebot.entity.retdata.ApiData;
import com.github.onebot.entity.retdata.ApiListData;
import com.github.onebot.entity.retdata.ApiRawData;
import com.github.onebot.entity.retdata.BooleanData;
import com.github.onebot.entity.retdata.CookiesData;
import com.github.onebot.entity.retdata.CredentialsData;
import com.github.onebot.entity.retdata.CsrfTokenData;
import com.github.onebot.entity.retdata.FileData;
import com.github.onebot.entity.retdata.FriendData;
import com.github.onebot.entity.retdata.GroupData;
import com.github.onebot.entity.retdata.GroupInfoData;
import com.github.onebot.entity.retdata.GroupMemberInfoData;
import com.github.onebot.entity.retdata.LoginInfoData;
import com.github.onebot.entity.retdata.MessageData;
import com.github.onebot.entity.retdata.StrangerInfoData;
import com.github.onebot.entity.retdata.VersionInfoData;
...
public class Bot {
    ...
    TypeReference<ApiData<MessageData>> apiDataMessage = new TypeReference<>() {
    };
    private long selfId;
    ...
    public Bot(long selfId, Session session, ApiHandler apiHandler, OneBotConfig oneBotConfig) {
        this.selfId = selfId;
        this.session = session;
        this.apiHandler = apiHandler;
        this.oneBotConfig = oneBotConfig;
        this.pluginList = oneBotConfig.getPluginList();
    }
    ...
    public ApiData callCustomApi(IApiRequest apiRequest) throws IOException, InterruptedException {
        return apiHandler.sendApiMessage(session, apiRequest).toJavaObject(ApiData.class);
    }
    ...
    public ApiData<MessageData> sendPrivateMsg(long user_id, String message, boolean auto_escape) {
        ...
        ApiData<MessageData> result = apiHandler.sendApiMessage(session, action, params).toJavaObject(apiDataMessage);
        return result;
    }
    ...
    public ApiRawData deleteMsg(int message_id) {
        ...
        ApiRawData result = apiHandler.sendApiMessage(session, action, params).toJavaObject(ApiRawData.class);
        return result;
    }
     ...
     *
     * @param group_id       群号
     * @param groupAnonymous 要禁言的匿名用户对象（群消息上报的 anonymous 字段）
     * @param duration       禁言时长，单位秒，无法取消匿名用户禁言
     * @return 结果
     */
    public ApiRawData setGroupAnonymousBan(long group_id, GroupAnonymous groupAnonymous, boolean duration) {
        ApiEnum action = ApiEnum.SET_GROUP_ANONYMOUS_BAN;

        JSONObject params = new JSONObject();
        params.put("group_id", group_id);
        params.put("anonymous", groupAnonymous);
        params.put("duration", duration);
    ...
    public ApiData<LoginInfoData> getLoginInfo() {
        ...
        ApiData<LoginInfoData> result = apiHandler.sendApiMessage(session, action, null).toJavaObject(new TypeReference<ApiData<LoginInfoData>>() {
        });
        return result;
    }
    ...
    public ApiData<StrangerInfoData> getStrangerInfo(long user_id, boolean no_cache) {
        ...
        ApiData<StrangerInfoData> result = apiHandler.sendApiMessage(session, action, params).toJavaObject(new TypeReference<ApiData<StrangerInfoData>>() {
        });
        return result;
    }
    ...
    public ApiListData<FriendData> getFriendList() {
        ...
        ApiListData<FriendData> result = apiHandler.sendApiMessage(session, action, null).toJavaObject(new TypeReference<ApiListData<FriendData>>() {
        });
        return result;
    }
    ...
    public ApiListData<GroupData> getGroupList() {
        ...
        ApiListData<GroupData> result = apiHandler.sendApiMessage(session, action, null).toJavaObject(new TypeReference<ApiListData<GroupData>>() {
        });
        return result;
    }
    ...
    public ApiData<GroupInfoData> getGroupInfo(long group_id, boolean no_cache) {
        ...
        params.put("group_id", group_id);
        params.put("no_cache", no_cache);
        ApiData<GroupInfoData> result = apiHandler.sendApiMessage(session, action, params).toJavaObject(new TypeReference<ApiData<GroupInfoData>>() {
        });
        return result;
    }
    ...
    public ApiData<GroupMemberInfoData> getGroupMemberInfo(long group_id, long user_id, boolean no_cache) {
        ...
        ApiData<GroupMemberInfoData> result = apiHandler.sendApiMessage(session, action, params).toJavaObject(new TypeReference<ApiData<GroupMemberInfoData>>() {
        });
        return result;
    }
    ...
    public ApiListData<GroupMemberInfoData> getGroupMemberList(long group_id) {
        ...
        params.put("group_id", group_id);
        ApiListData<GroupMemberInfoData> result = apiHandler.sendApiMessage(session, action, params).toJavaObject(new TypeReference<ApiListData<GroupMemberInfoData>>() {
        });
    ...
    public ApiData<CookiesData> getCookies(String domain) {
        ...
        ApiData<CookiesData> result = apiHandler.sendApiMessage(session, action, params).toJavaObject(new TypeReference<ApiData<CookiesData>>() {
        });
        return result;
    }
    ...
    public ApiData<CsrfTokenData> getCsrfToken() {
        ...
        ApiData<CsrfTokenData> result = apiHandler.sendApiMessage(session, action, null).toJavaObject(new TypeReference<ApiData<CsrfTokenData>>() {
        });
        return result;
    }
    ...
    public ApiData<CredentialsData> getCredentials(String domain) {
        ...
        ApiData<CredentialsData> result = apiHandler.sendApiMessage(session, action, params).toJavaObject(new TypeReference<ApiData<CredentialsData>>() {
        });
        return result;
    }
    ...
    public ApiData<FileData> getRecord(String file, String out_format, boolean full_path) {
        ...
        ApiData<FileData> result = apiHandler.sendApiMessage(session, action, params).toJavaObject(new TypeReference<ApiData<FileData>>() {
        });
        return result;
    }
    ...
    public ApiData<BooleanData> canSendImage() {
        ...
        ApiData<BooleanData> result = apiHandler.sendApiMessage(session, action, null).toJavaObject(new TypeReference<ApiData<BooleanData>>() {
        });
        return result;
    }
     ...
     * @return 结果
     */
    public ApiData<Status> getStatus() {
        ApiEnum action = ApiEnum.GET_STATUS;

        ApiData<Status> result = apiHandler.sendApiMessage(session, action, null).toJavaObject(new TypeReference<ApiData<Status>>() {
        });
        return result;
    }
    ...
    public ApiData<VersionInfoData> getVersionInfo() {
        ...
        ApiData<VersionInfoData> result = apiHandler.sendApiMessage(session, action, null).toJavaObject(new TypeReference<ApiData<VersionInfoData>>() {
        });
        return result;
    }
    ...
    public ApiRawData cleanPluginLog() {
        ...
        ApiRawData result = apiHandler.sendApiMessage(session, action, null).toJavaObject(ApiRawData.class);
        return result;
    }
}
